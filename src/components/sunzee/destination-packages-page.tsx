          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-8 order-2 lg:order-1">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-[var(--ocean)]/12">
                          ...
                          <a
                            ...
                            className="group/btn inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[var(--coral)] to-[var(--coral-deep)] px-5 py-2.5 text-xs font-semibold text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all"
                          >
                            Book Now
              ...
              <div className="mt-10 rounded-3xl bg-gradient-to-r from-[var(--ocean)] to-[var(--ocean-deep)] text-white p-7 md:p-8 flex flex-col md:flex-row items-center justify-between gap-5 relative overflow-hidden">
                ...
                <a
                  href="/#enquiry"
                  className="relative inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[var(--coral)] to-[var(--coral-deep)] px-6 py-3 text-sm font-semibold text-white shadow-lg hover:-translate-y-0.5 transition-all"
                >
              ...
              <div className="lg:sticky lg:top-24 space-y-5">
                ...
                <div className="rounded-3xl border border-[var(--ocean)]/15 bg-white p-5 shadow-sm">
                  ...
                  <button
                    ...
                    className="mt-3 w-full rounded-full bg-gradient-to-r from-[var(--coral)] to-[var(--coral-deep)] px-4 py-2 text-xs font-semibold text-white hover:shadow-md transition-all"
                  >
                    Search Now
                  </button>
                </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-[var(--ocean)] to-[var(--ocean-deep)] text-white p-5 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <a
                      ...
                      className="block rounded-xl bg-gradient-to-r from-[var(--coral)] to-[var(--coral-deep)] text-white px-4 py-2.5 text-center text-sm font-semibold hover:shadow-lg transition-all"
                    >
                      {SITE.phone}
                    </a>
                  </div>
